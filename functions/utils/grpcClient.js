...
const getGrpcClient = async function (region) {
    console.log(chalk.cyan('gRPC Client is using region:', chalk.red(region)));
    ...
    const grpcEndpoint = process.env['ASTRA_GRAPHQL_ENDPOINT_' + region].split("/")[2];
